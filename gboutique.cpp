...
void gboutique::on_pushButton_clicked()
{
    ui->tab_av->setModel(a.afficherTri());

}

void gboutique::on_pb_supprimer_clicked()
...
void gboutique::on_modifier_clicked()
...
void gboutique::on_pushButton_2_clicked()
{
...
/*void gboutique::on_modifier_2_clicked()
{
    QSqlDatabase db;
                   QTableView tab_av;
...
void   gboutique::mailSent(QString status)
{
...
/*void gboutique::on_browse_clicked()
{
  // browse();
