...
void gvol::on_afficher_2_clicked()
{
    ui->tab_vols->setModel(v.afficher());
}
void gvol::on_pb_ajouter_clicked()
{
...
void gvol::on_pb_supprimer_clicked()
{
...
void gvol::on_linecomboBox_activated(const QString &arg1)
{
...
void gvol::on_actionajouter_triggered()
{
    ui->tab_widget->setCurrentIndex(0);
}

void gvol::on_actionafficher_3_triggered()
{
    ui->tab_widget->setCurrentIndex(1);

}

void gvol::on_actionrechercher_2_triggered()
{
    ui->tab_widget->setCurrentIndex(2);

}

void gvol::on_actionmap_2_triggered()
{
    ui->tab_widget->setCurrentIndex(6);

}

void gvol::on_actionPdf_triggered()
{
    ui->tab_widget->setCurrentIndex(3);

}
void gvol::on_actionChat_Bot_triggered()
{
    ui->tab_widget->setCurrentIndex(5);

}

void gvol::on_actionQuitter_triggered()
{
    ui->tab_widget->close();
}
void gvol::on_actionQuitter_clicked()
{
    ui->tab_widget->close();

}
void gvol::on_pb_effacer_clicked()
{
    ui->num->clear();
    ui->choisir->clear();
    ui->depart->clear() ;
...
void gvol::on_pushButton_clicked()
{
    ui->num_2->clear();
    ui->choisir_2->clear();
    ui->depart_2->clear() ;
...
void gvol::on_num_3_textChanged(const QString &re)
{
    ui->tab_recherche->setModel(v.recherche(re));
}

void gvol::on_pushButton_pdf_clicked()
{
    QPrinter print;
...
void gvol::on_retour_arduino_clicked()
{
    ui->tab_widget->close();

}

void gvol::on_retour_1_clicked()
{
    ui->tab_widget->close();
}
void gvol::on_retour_2_clicked()
{
    ui->tab_widget->close();
}
void gvol::on_retour_3_clicked()
{
    ui->tab_widget->close();
}
void gvol::on_retour_4_clicked()
{
    ui->tab_widget->close();
}
void gvol::on_retour_13_clicked()
{
    ui->tab_widget->close();
}
void gvol::on_retour_6_clicked()
{
    ui->tab_widget->close();
}
void gvol::on_retour_7_clicked()
{
    ui->tab_widget->close();
}

void gvol::on_actionStatistique_triggered()
{
    ui->tab_widget->show();
...
void gvol::on_tab_vols_clicked(const QModelIndex &index)
{
    QString pdf;
...
void gvol::on_ajout_arduino_clicked()
{
...
void gvol::on_effacer_arduino_clicked()
{
    ui->id_arduino->clear();
...
void gvol::on_modifier_arduino_clicked()
{
    int soldeaa=ui->solde_arduino->text().toInt();
    QString nomaa=ui->nom_arduino->text();
    QString prenomaa=ui->prenom_arduino->text();
