...
gavions::gavions(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::gavions)
{
    ui->setupUi(this);
...
void gavions::on_pushButton_Ajouter_clicked()
{
...
void gavions::on_pushButton_clicked()
{
...
void gavions::on_pb_supprimer_clicked()
{
...
void gavions::on_modifier_clicked()
{
    QSqlQuery query;
...
void gavions::on_comboBox_activated(const QString &arg1)
{
    tri=arg1;
}

void gavions::on_comboBox_2_activated(const QString &arg2)
{
    recherche=arg2;
}

void gavions::on_pushButton_2_clicked()
{
...
void gavions::on_tab_av_activated(const QModelIndex &index)
{
...
void gavions::on_pushButton_4_clicked()
{
    QTableView tab_av;
...
void gavions::on_calendarWidget_activated(const QDate &date)
{
...
void gavions::on_pushButton_9_clicked()
{
    QString etat1="1";
    QSqlQuery qury;
    int nbav=0;
...
void gavions::on_pushButton_stat_clicked()
{
...
void gavions::on_pushButton_10_clicked()
{
    blocknotee =new blocknote(this);
    blocknotee->show();
}

void gavions::update_label()
{
...
void gavions::on_pushButton_11_clicked()
{
    QString ard=ui->lineEdit_ID_AVION_5->text();
    QSqlQuery q;
     QString etatactuel;
