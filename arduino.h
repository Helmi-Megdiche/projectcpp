...
//et des fonctions (envoi, lecture de rÃ©ception,..) sur ce quâ€™est une voie sÃ©rie pour Arduino.
static const quint16 arduino_uno_vendor_id=9025;
static const quint16 arduino_uno_producy_id=67;
QString arduino_port_name;
bool arduino_is_available;
QByteArray data; // contenant les donnÃ©es lues a partir d'Arduino
