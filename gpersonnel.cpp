...
gpersonnel::gpersonnel(QWidget *parent)
    : QDialog(parent),
    ui(new Ui::gpersonnel)
{
...
void gpersonnel::on_pushButton_Ajouter_clicked()
{
...
void gpersonnel::on_pushButton_clicked()
{
    ui->tab_af->setModel(a.afficher());

}

void gpersonnel::on_pb_supprimer_clicked()
{
...
void gpersonnel::on_modifier_clicked()
{
    QSqlQuery query;
...
void gpersonnel::on_linecomboBox_currentIndexChanged(const QString &x)
{
...
void gpersonnel::on_rechercher_textChanged(const QString &arg1)//recherche
{
...
void gpersonnel::on_pushButton_pdf_clicked()
{
...
void gpersonnel::on_tableView_clicked(const QModelIndex &index)
{
...
void gpersonnel::on_pushButton_STSAT_clicked()
{
    ui->tabWidget->show();
...
void gpersonnel::on_pushButton_7_clicked()//ajout_cong
{
...
void gpersonnel::on_pb_supp1_clicked()
{
    QSqlQuery query;
...
void gpersonnel::on_pushButton_5_clicked()
{
    QSqlQuery query;
    QString ID_PERSONNEL=ui->ID_cong->text();
...
void gpersonnel::on_pushButton_9_clicked()
{
    QSqlQuery req;
...
void gpersonnel::on_pushButton_10_clicked()
{
    QSqlQuery query;
    QString ID_PERSONNEL=ui->ID_cong->text();
...
void gpersonnel::on_pushButton_mail_clicked()
{
...
void gpersonnel::on_ajout_arduino_clicked()
{
...
void gpersonnel::on_effacer_arduino_clicked()
{
    ui->id_arduino->clear();
...
void gpersonnel::on_modifier_arduino_clicked()
{
    int soldeaa=ui->solde_arduino->text().toInt();
    QString nomaa=ui->nom_arduino->text();
    QString prenomaa=ui->prenom_arduino->text();
