...
nom="";prenom="";dest="";classe="";numvol="";
}
Passager::Passager(QString nom,QString prenom ,int numpass,QString dest ,QString classe,int billet,int bag,QString numvol)
{this->nom=nom ; this->prenom=prenom; this->numpass=numpass; this->dest=dest ; this->classe=classe; this->billet=billet; this ->bag=bag;this->numvol=numvol;}
...
{this->classe=classe;}
void Passager::setnumvol(QString numvol)
{this->numvol=numvol;}
...
bool Passager::ajouter()
{
    ...
    QSqlQuery query;
        ...
        QString bag_string= QString::number(bag);
          ...
          query.prepare("INSERT INTO PASSAGER (numpass, bag, prenom,classe,nom,dest,billet,numvol) "
                        "VALUES (:NUMPASS, :BAG, :PRENOM, :CLASSE, :NOM, :DEST, :BILLET,:NUMVOL)");
...
QSqlQueryModel *Passager::afficher()
{
    QSqlQueryModel *model = new QSqlQueryModel;
        ...
        model->setHeaderData(7, Qt::Horizontal, QObject::tr("Numero vol"));
